...
TEST_F(CustomActionDataTest, When_ServiceExists_And_NoUser_ReturnsFalse)
{
    ...
    bool result =
        canInstall(true /*isDC*/, false /*ddUserExists*/, true /*ddServiceExists*/, customActionCtx, shouldResetPass);
...
TEST_F(CustomActionDataTest, When_ServiceDoesNotExists_And_UserExists_ButNoPassword_ReturnsFalse)
{
    ...
    bool result =
        canInstall(true /*isDC*/, false /*ddUserExists*/, false /*ddServiceExists*/, customActionCtx, shouldResetPass);
